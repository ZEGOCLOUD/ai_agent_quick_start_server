...
5. 自定义调用 TTS：`http://localhost:3000/api/send-agent-instance-tts`
6. 结束与智能体通话： `http://localhost:3000/api/stop`
...
4. 开始与播报数字人智能体通话：`https://cute-******.netlify.app/api/start-live-digital-human`
5. 自定义调用 TTS：`https://cute-******.netlify.app/api/send-agent-instance-tts`
6. 结束与智能体通话： `https://cute-******.netlify.app/api/stop`
...
使用该域名可访问API接口：
1. 获取 Token：`https://****.vercel.app/api/zego-token`
2. 开始与智能体通话： `https://****.vercel.app/api/start`
3. 开始与数字人智能体视频通话：`https://****.vercel.app/api/start-digital-human`
4. 开始与播报数字人智能体通话：`https://****.vercel.app/api/start-live-digital-human`
5. 自定义调用 TTS：`https://****.vercel.app/api/send-agent-instance-tts`
6. 结束与智能体通话： `https://****.vercel.app/api/stop`
